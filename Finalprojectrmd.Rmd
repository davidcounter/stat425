...
dat = data.frame(rep(0,4617600), rep(0,4617600), rep(0,4617600), rep(0,4617600), rep(0,4617600), rep(0,4617600), rep(0,4617600), rep(0,4617600), rep(0,4617600), rep(0,4617600), rep(0,4617600), rep(0,4617600), rep(0,4617600), rep(0,4617600), rep(0,4617600), rep(0,4617600), rep(0,4617600), rep(0,4617600), rep(0,4617600), rep(0,4617600), rep(0,4617600), rep(0,4617600), rep(0,4617600), rep(0,4617600))
...
for (i in 1:4617600){
  for(j in 1:20517){
    ...
    if(train$store_nbr[i] == 1 &
       ...
       train$date[i] %in% weather$date[j]){
          dat[i,] <- cbind(train[i,],weather[j,])
       }
