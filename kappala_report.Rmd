...
weather = read.csv("weatherclean.csv", stringsAsFactors = FALSE)
...
tibble(
  "Column" = colnames(weather[-(1:3)]),
  "Percentage of Missing Values (%)" =  as.numeric(colMeans(is.na(weather[-(1:3)]))) * 100
) %>%
