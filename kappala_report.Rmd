...
```{r, eval = FALSE}
mergedata = read.csv("stat425/mergedata.csv")
testy = read.csv("stat425/mergedtestdata.csv")
...
# 
# testy$blackFriday = 0
# testy$blackFriday[testy$date == "2014-11-28"] = 1
# 
# 
# write.csv(no_zeros, file = "refined_data.csv", row.names = FALSE)
# write.csv(testy, file = "mergedtestdata.csv", row.names = FALSE)
...
```{r, include = FALSE}
refined_data = read.csv("stat425/refined_data.csv")

test_data = read.csv("stat425/mergedtestdata.csv")
...
test_data$store_nbr <- as.factor(test_data$store_nbr)
test_data$item_nbr <- as.factor(test_data$item_nbr)
```
...
predictions[!test_data$id %in% refined_data$id] = 0
sampleSub = read.csv("stat425/sampleSubmission.csv")
